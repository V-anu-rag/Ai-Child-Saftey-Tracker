...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 18, fontWeight: "900", color: COLORS.jet, marginTop: 16 },
  emptySub: { fontSize: 14, color: COLORS.textMuted, marginTop: 4, textAlign: "center", fontWeight: "500" },
  map: { flex: 1 },
  markerOuter: { width: 44, height: 44, borderRadius: 22, backgroundColor: COLORS.primary, borderWidth: 3, borderColor: "#fff", alignItems: "center", justifyContent: "center", shadowColor: COLORS.jet, shadowOpacity: 0.2, shadowRadius: 8, elevation: 6 },
  markerSelected: { width: 52, height: 52, borderRadius: 26, borderWidth: 4 },
  markerInner: { alignItems: "center", justifyContent: "center" },
  zoneDot: { width: 26, height: 26, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  callout: { padding: 10, minWidth: 140 },
  calloutName: { fontWeight: "800", fontSize: 14, color: COLORS.jet, marginBottom: 4 },
  calloutText: { fontSize: 12, color: COLORS.textMuted, fontWeight: "600" },
  childPills: { 
    position: "absolute", 
